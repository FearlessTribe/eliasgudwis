  ...
  return (
    <section className="legal">
      <div className="wrap legal-body">
        <p className="mono kicker">Rechtliches</p>
        <h1>Impressum</h1>
        ...
        <p>Vertreten durch: Elias Gudwis</p>
        <h2>Kontakt</h2>
        <p>
          Telefon: <a href="tel:+4915901484601">+49 159 0148 4601</a>
          <br />
          E-Mail:{' '}
          <a href="mailto:info@ghostwriting-gudwis.de">info@ghostwriting-gudwis.de</a>
        </p>
        ...
        <p>
          ...
          Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben. Weitere
